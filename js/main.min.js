...
function verfiyOtp(e, check) {
  ...
  let otp =
    document.querySelector(
      check == 0 ? "#_1st" : check == 1 ? "#_1st_" : "#__1st"
    )?.value +
    document.querySelector(
      check == 0 ? "#_2nd" : check == 1 ? "#_2nd_" : "#__2nd"
    )?.value +
    document.querySelector(
      check == 0 ? "#_3rd" : check == 1 ? "#_3rd_" : "#__3rd"
    )?.value +
    document.querySelector(
      check == 0 ? "#_4th" : check == 1 ? "#_4th_" : "#__4th"
    )?.value;
  // let otp =
  //   document.querySelector("#__1st")?.value +
  //   document.querySelector("#__2nd")?.value +
  //   document.querySelector("#__3rd")?.value +
  //   document.querySelector("#__4th")?.value;
  ...
  axios
    ...
    .catch((err) => {
      ...
      console.log("el ==", document.querySelector("#location1"));
...
function openApi(name, phone, email) {
  phoneNo = phone;
