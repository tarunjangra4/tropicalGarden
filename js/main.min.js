...
function readMoretwo(e) {
  document.querySelector(".moreText").style.display = "block";
  document.querySelector(".lessText").style.display = "none";
}

function readLess() {
  document.querySelector(".moreText").style.display = "none";
  document.querySelector(".lessText").style.display = "block";
}
  ...
  axios
    ...
    .then((res) => {
      ...
      let enquiryForm = document.querySelector(
        count == 1 ? ".enquiryMain1" : ""
      );
      let verifyOtp = document.querySelector(
        count == 1 ? ".otpVerification1" : ""
      );
...
function checkNew(e, count) {
  ...
  let name = document.querySelector(count == 1 ? "#name1" : "")?.value;
  let phone = document.querySelector(count == 1 ? "#phone1" : "")?.value;
  let email = document.querySelector(count == 1 ? "#email1" : "")?.value;
  let btn = document.querySelector(count == 1 ? ".getInfoBtn1" : "");
  if (name !== "" && phone !== "" && email !== "") {
    console.log("if", name, phone, email);
    btn.disabled = false;
...
function readMore(e, count) {
  e.stopPropagation();
  let lessText1 = document.querySelector(count == 1 ? ".lessText1" : "");
  let moreText1 = document.querySelector(count == 1 ? ".moreText1" : "");
...
function changePhoneNo1(e, count) {
  let enquiryForm = document.querySelector(count == 1 ? ".enquiryMain1" : "");
  let verifyOtp = document.querySelector(count == 1 ? ".otpVerification1" : "");
  verifyOtp.style.display = "none";
